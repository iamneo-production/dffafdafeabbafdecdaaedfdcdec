const { validateRegistration } = require('./public/registrationValidation'); // Update the path accordingly
const { validateLogin } = require('./public/loginValidation'); // Update the path accordingly
